...
public class UnsortedTableMap<K,V> extends AbstractMap<K,V> {
  ...
  /**
   * Problem 1 solution: containsKey
   */

  public boolean containsKey(K key) {
    // easy way: use the methods defined in UnsortedTableMap
/*  if(get(key) == null) {  // Call the method get, which returns null if there is no value is found
      return false;
    }
    else return true;  
*/

    // alternate way: Use java ArrayList and Object methods
    int size = table.size();  
