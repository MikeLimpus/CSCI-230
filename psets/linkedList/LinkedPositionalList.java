...
public class LinkedPositionalList<E> implements PositionalList<E>, Cloneable{
   ...
   * Modify the LinkedPositionalList implementation, as described in Section 3.6 from the course primary textbook,
   * to support the Cloneable interface.
   */
  public LinkedPositionalList<E> clone() throws CloneNotSupportedException{
    ...
    if(size() > 0) {
      ...
      Node<E> iter = header.getNext(); //This node is used for iteration throughout the original list
