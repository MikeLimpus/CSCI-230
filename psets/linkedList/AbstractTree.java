...
// import LabPriorityQueue.Position;
...
public abstract class AbstractTree<E> implements Tree<E> {
   ...
   * Implement a preorder traversasl lazy iterator for the AbstractTree<E> class, that is, your
   * iterator must step through the elements of the tree in the same order a preorder traversal would.
   */
