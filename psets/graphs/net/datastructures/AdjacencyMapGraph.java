...
public class AdjacencyMapGraph<V, E> implements Graph<V, E> {
  ...
  // This list will hold the visted vertices for both functions
  public LinkedList<Vertex<V>> visted = new LinkedList<Vertex<V>>();
  private boolean cycle;

  /**
   * helper: this will allow us to pass in vertex parameters for easier access, the 
   * real 'meat' of the algorithm
   * @param g
   * @param v
   * @return true if there is a cycle
   */
  public boolean helper(AdjacencyMapGraph<V,E> g, Vertex<V> v) {
    visted.add(v);
    for (Edge<E> e : g.outgoingEdges(v)) {
      Vertex<V> connected[] = g.endVertices(e);
      for (int j = 0; j < visted.size(); j++) {
        if(connected[1].equals(visted.get(j)))
          return cycle = true;
      }
      helper(g,connected[1]);
    }
  ...
  /**
   * containsCycle - essentially a loop for a our helper function
   * @param g
   * @return true if there is a cycle
   */
  public boolean containsCycle(AdjacencyMapGraph<V, E> g) {
  
    Iterable<Vertex<V>> vertex = g.vertices();
  ...
  public static void main(String args[]) {
    ...
    AdjacencyMapGraph<Integer, String> undirectedGraph = new AdjacencyMapGraph<>(false);

    AdjacencyMapGraph<Integer, String> testGraphNL = new AdjacencyMapGraph<>(true);
    Vertex<Integer> testVert1 = testGraphNL.insertVertex(1);
    Vertex<Integer> testVert2 = testGraphNL.insertVertex(2);
    ...
    System.out.println("Test 1: no cycle....\nResult: " + undirectedGraph.containsCycle(testGraphNL));

    AdjacencyMapGraph<Integer, String> testGraphFL = new AdjacencyMapGraph<>(true);
    ...
    Vertex<Integer> testVert3 = testGraphFL.insertVertex(3);
    ...
    System.out.println("Test 2, 'False' cycle....\nResult: " + undirectedGraph.containsCycle(testGraphFL));

    AdjacencyMapGraph<Integer, String> testGraphL = new AdjacencyMapGraph<>(true);
    ...
    Vertex<Integer> testVert4 = testGraphL.insertVertex(4);
    ...
    System.out.println("Test 3, with Cycle....\nResult: " + undirectedGraph.containsCycle(testGraphL));
    // System.out.print("\n");
